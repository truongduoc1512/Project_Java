document.addEventListener("DOMContentLoaded", function () {
    ...
    const pages = {
        "Trang chủ": "<h1>Trang chủ</h1><p>Đây là trang chủ của hệ thống quản lý tiêm vaccine.</p>",
        "Dịch vụ tiêm chủng": "<h1>Dịch vụ tiêm chủng</h1><p>Thông tin về dịch vụ tiêm vaccine.</p>",
        "Bảng giá": "<h1>Giá</h1><p>Thông tin về giá tiêm vaccine.</p>",
        "Cẩm nang tiêm chủng": "<h1>Cẩm nang tiêm chủng</h1><p>Hướng dẫn tiêm vaccine.</p>",
        ...
        "Đặt lịch": "<h1>Trang Đặt lịch</h1><p>Đây là trang đặt lịch tiêm vaccine.</p>",
        "Chăm sóc khách hàng": "<h1>Chăm sóc khách hàng</h1><p>Hỗ trợ khách hàng về tiêm vaccine.</p>",
        "Cập nhật hồ sơ trẻ em": "<h1>Cập nhật hồ sơ trẻ em</h1><p>Thay đổi thông tin hồ sơ của trẻ.</p>",
        "Cập nhật quá trình tiêm chủng": "<h1>Cập nhật quá trình tiêm chủng</h1><p>Quản lý tiến trình tiêm chủng.</p>",
        "Thông báo": "<h1>Thông báo</h1><p>Các thông báo mới nhất về tiêm vaccine.</p>",
        "Support": "<h1>Hỗ trợ</h1><p>Trợ giúp và hướng dẫn sử dụng hệ thống.</p>",
        "Lịch sử giao dịch": "<h1>Lịch sử giao dịch</h1><p>Danh sách các giao dịch đã thực hiện.</p>",
        "Phản hồi": "<h1>Phản hồi</h1><p>Đóng góp ý kiến và phản hồi về hệ thống.</p>"
    };
